...
<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
				...
				<?php if ( ! empty( $post->post_parent ) ) : ?>
					<p class="page-title"><a href="<?php echo get_permalink( $post->post_parent ); ?>" title="<?php esc_attr( printf( __( 'Return to %s', 'mav' ), get_the_title( $post->post_parent ) ) ); ?>" rel="gallery"><?php
						...
						printf( __( '<span class="meta-nav"></span> %s', 'mav' ), get_the_title( $post->post_parent ) );
					?></a></p>
				<?php endif; ?>
				...
				<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<div class="entry-meta">
						<?php
							printf( __( '<span class="%1$s">By</span> %2$s', 'mav' ),
						...
						<?php
							printf( __( '<span class="%1$s">Published</span> %2$s', 'mav' ),
						...
						?>
						<?php edit_post_link( __( 'Edit this entry', 'mav' ), '<span class="meta-sep">|</span> <span class="edit-link">', '</span>' ); ?>
					</div><!-- .entry-meta -->
