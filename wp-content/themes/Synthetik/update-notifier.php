...
define( 'NOTIFIER_THEME_NAME', 'Spark' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'spark' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://demo.mattiaviviani.com/wp_themes/spark/notifier.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
